...
To overcome this, our algorithm acts as a \textit{Physics-Informed Geometric Search} (PI-GS), utilizing the strict geometric relationship between $\tau_{VL}(\mathbf{p})$ and $\tau_{VR}(\mathbf{p})$ as an immutable constraint.
