...
```
┌────────────────────────────────────────────────────────────────────────────────┐
│                    block         block-2        block-3(high)  block-4(high)   │
│ ──────────────────────────────────────────────────────────────────────────    │
│ 喇叭位置           +0.4m         +0.4m          +0.4m          +0.8m          │
│ 無擋 baseline      (N/A)         (N/A)          +5.90°         +8.86°         │
│ MIC-MIC Fullband   +5.91°        +0.01°         +90.00°        +19.38°        │
│ MIC-MIC 誤差       -4.80°        -10.70°        +79.29°        -1.44°         │
│ MIC-MIC 狀態       ⚠️部分成功    ❌ 鎖0°        ❌❌ 完全崩潰   ⚠️ 碰巧接近   │
│ ──────────────────────────────────────────────────────────────────────────    │
│ LDV 策略2 自動     +5.99°        +7.21°         +3.70°         +3.80°         │
│ LDV 策略2 誤差     -4.72°        -3.50°         -7.01°         +10.02°        │
│ LDV oracle         +11.47°       +10.28°        +11.89°        -6.15°         │
│ LDV oracle 誤差    +0.76°        -0.43°         +1.18°         +0.06°         │
│ ──────────────────────────────────────────────────────────────────────────    │
│ 改善倍數(策略2)    ~1x           3.1x           11.3x          0.1x           │
│ ──────────────────────────────────────────────────────────────────────────    │
│ LDV 打點位置       偏低          偏低           上移 ✅         上移 ✅         │
│ VR 理論peak排名    #3            #5             #1 ⭐          #210           │
│ ──────────────────────────────────────────────────────────────────────────    │
│ 結論:                                                                          │
...
### 14.2 四組遮擋資料集 + 兩組無擋對照 總覽

| 資料集 | 喇叭 | 打點 | 無擋 err | Block MIC err | LDV S2 err | Oracle err | VR 峰排名 |
|--------|------|------|----------|---------------|------------|------------|----------|
| block | +0.4m | 低 | (N/A) | -4.80° | -4.72° | +0.76° | #3~#5 |
| block-2 | +0.4m | 低 | (N/A) | -10.70° | -3.50° | -0.43° | #3~#5 |
| block-3(high) | +0.4m | **高** | +5.90° | **+79.29°** | -7.01° | +1.18° | **#1** |
| block-4(high) | **+0.8m** | **高** | +8.86° | -1.44° | +10.02° | **+0.06°** | #210 |
